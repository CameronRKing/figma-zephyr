...
export default {
    ...
    // },
    cl: {
        id: 'tensor.lace.create',
        label: 'Create ring lace',
        args: [
            { name: 'numRings', type: 'text', label: 'Number of rings' },
            { name: 'cubit', type: 'select', label: 'Cubit', options: () => cubits },
            { name: 'fraction', type: 'text', label: 'Fraction' },
